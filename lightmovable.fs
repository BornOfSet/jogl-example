...
{	
	...
	vec3 Object = vec3(-0.3,0.2,0);//光追对象的位置
	...
	vec3 Normal = OnSurface;//碰撞处几何表面的法线。注意，Normal并非onSurface-Object。在计算Collision的时候已经考虑到了对Object的相对方向，可以说OnSurface是从Object球心出发的，自然指的是法线
